...
(function() {
  var Cookies, GIGABYTE, History, addFile, api, files, initFilePages, loadStats, makeHandler, pickFilePage, pickPagination, selectElementText, showUploadStage, uploadFile;
  ...
  initFilePages = function() {
    ...
    for (i = _i = 0, _ref = Math.max(parseInt(count / 10), 1); 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
