/*
1. IDBObjectStore.add/put cases:

keyPath	autoInc	keyInValue	keyAsArg	Result				Covered by
-------	-------	----------	--------	------				----------
Array	True	..			..			InvalidAccessError	Can't create such ObjectStore
No		False	N/A			No			DataError			testAddDataError
Yes/Arr	..		..			Yes			DataError			testAddDataError
Yes/Arr	False	No			..			DataError			testAddDataError

No		False	N/A			Yes			success				testOutOfLineKey
Yes		False	Yes			No			success				testInlineStringKey
Array	False	Yes			No			success				testInlineArrayKey

No		True	N/A			No			success				testOutOfLineKeyWithKeyGenerator
No		True	N/A			Yes			success				testOutOfLineKeyWithKeyGenerator
Yes		True	No			No			success				testInlineKeyWithKeyGenerator
Yes		True	Yes			No			success				testInlineKeyWithKeyGenerator
*/
...
var IDBObjectStoreTests = new (function ()
{
	...
	function testAddDataError(db)
	{
		...
		try { cars.add({ number : [3, [[], 2], { }], attr : "bla", key : "2"}); }
		catch (ex)
		{
			ok(dataErrors.contains(ex.name), "DataError expected. " +
	...
	function testOutOfLineKeyWithKeyGenerator(db)
	{
		...
		var records = [{ key : 8.3, value : { name : "Car store 1" } },
